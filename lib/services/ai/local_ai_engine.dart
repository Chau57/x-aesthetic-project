...
class LocalAiEngine implements AiEngine {
  ...
  Future<void> init() async {
    ...
    if (_initCompleter != null) {
      print("AI Coach Loader: init() already in progress, awaiting existing completer.");
    ...
    try {
      ...
      try {
        ...
        samplingParams.temp = 0.5;
        samplingParams.penaltyRepeat = 1.2;
